...
<meta charset="ISO-8859-1">
	<link href="<c:url value='/css/anuncioStyle.css'/>" rel="stylesheet" type="text/css">
<link rel="stylesheet"
                            ...
                            <div class="avaliacoes-c">
                                ...
                                <div class="avaliacao">
                                    ...
                                    <div class="nome_avaliacao">
                                        <h6 class="nome_avaliacao_1">Nome</h6>
                                        <h6 class="nome_avaliacao_2">Nota</h6>
                                    </div>
                                </div>
                                <div class="avaliacao">
                                    <div class="descricao__avaliacao">
                    ...
                    <div class="contato__Anuncio-c">
                        ...
                        <div class="dados__prestador">
                            ...
                            <div class="opcoes__anuncio">
                               <button class="btn btn-warning" style="width: 200px; margin-top: 12px;">Entre em contato</button><br/>
